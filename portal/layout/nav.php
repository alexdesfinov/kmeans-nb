<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <ul class="navbar-nav">
    ...
    <?php if (($_SESSION['level'] ?? 'user') === 'admin'): ?>
      <!-- menu admin -->
      <li class="nav-item">
        <a class="nav-link <?php echo !isset($_GET['module']) ? 'active' : '' ?> " href="?">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['module'] ?? '') == 'inputData' ? 'active' : '' ?> " href="?module=inputData">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['module'] ?? '') == 'uploadDataset' ? 'active' : '' ?> " href="?module=uploadDataset">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['module'] ?? '') == 'dataTraining' ? 'active' : '' ?> " href="?module=dataTraining">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['module'] ?? '') == 'dataTesting' ? 'active' : '' ?> " href="?module=dataTesting">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-bar-graph-fill" viewBox="0 0 16 16">
              <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m.5 10v-6a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5m-2.5.5a.5.5 0 0 1-.5-.5v-4a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5zm-3 0a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5z" />
            </svg>
      ...
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Analisis</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['module'] ?? '') == 'hasil_tes' ? 'active' : '' ?> " href="?module=hasil_tes">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart-line-fill" viewBox="0 0 16 16">
              <path d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1z" />
            </svg>
          </div>
          <span class="nav-link-text ms-1">Hasil K-Means</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['module'] ?? '') == 'hasil_tes_naive' ? 'active' : '' ?> " href="?module=hasil_tes_naive">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-graph-up" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M0 0h1v15h15v1H0zm14.817 3.113a.5.5 0 0 1 .07.704l-4.5 5.5a.5.5 0 0 1-.74.037L7.06 6.767l-3.656 5.027a.5.5 0 0 1-.808-.588l4-5.5a.5.5 0 0 1 .758-.06l2.609 2.61 4.15-5.073a.5.5 0 0 1 .704-.07"/>
            </svg>
          </div>
          <span class="nav-link-text ms-1">Hasil Naive Bayes</span>
        </a>
      </li>
      <li class="nav-item mt-3">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['module'] ?? '') == 'print' ? 'active' : '' ?> " href="module/print/index.php">
          ...
          <span class="nav-link-text ms-1">Cetak Hasil</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['module'] ?? '') == 'user' ? 'active' : '' ?> " href="?module=user">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <?php if (($_SESSION['level'] ?? 'user') === 'user'): ?>
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['module'] ?? '') == 'inputDataUser' ? 'active' : '' ?> " href="?module=inputDataUser">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-text-fill" viewBox="0 0 16 16">
              <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1m-.5 2.5A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5M5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1m0 2h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1" />
            </svg>
