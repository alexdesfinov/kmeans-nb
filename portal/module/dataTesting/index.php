<div class="row">
    <div class="col-sm-12">
        ...
        $query = $conn->query("SELECT * FROM dataset_testing WHERE jenisData='testing'");
        ...
        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between mb-4">
            <div class="d-flex align-items-center mb-2 mb-md-0">
                <div class="icon icon-shape icon-gradient-warning shadow text-center border-radius-md d-inline-flex align-items-center justify-content-center me-3" style="width:48px;height:48px;">
                ...
                <div>
                    <h5 class="mb-0" style="font-weight:700;">Data Testing</h5>
                    <p class="mb-0" style="font-size:0.78rem;color:#627594;">
                        <span class="badge" style="background:rgba(251,207,51,0.15);color:#b8860b;font-size:0.7rem;"><?= $totalRows ?> data</span>
                    </p>
                </div>
            </div>
